...
class ApiPlatformConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
     ...
     * @template TValue
     * @param TValue $value
     * @default {"enabled":false,"default_ide":"graphiql","graphiql":{"enabled":false},"graphql_playground":{"enabled":false},"introspection":{"enabled":true},"max_query_depth":20,"max_query_complexity":500,"nesting_separator":"_","collection":{"pagination":{"enabled":true}}}
    ...
    */
    ...
    /**
     * @default {"enabled":true,"hub_url":null,"include_type":false}
    */
    ...
    */
    ...
    /**
     * @default {"contact":{"name":null,"url":null,"email":null},"termsOfService":null,"tags":[],"license":{"name":null,"url":null},"swagger_ui_extra_configuration":[],"overrideResponses":true}
    */
