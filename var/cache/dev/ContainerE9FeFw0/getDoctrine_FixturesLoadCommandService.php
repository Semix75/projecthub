...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-fixtures-bundle/src/FixtureGroupInterface.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/friendsFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/requestFixtures.php';
