...
class getApiPlatform_Doctrine_Orm_Listener_Mercure_PublishService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/doctrine-common/Messenger/DispatchTrait.php';
        include_once \dirname(__DIR__, 4).'/vendor/api-platform/symfony/Doctrine/EventListener/PublishMercureUpdatesListener.php';
