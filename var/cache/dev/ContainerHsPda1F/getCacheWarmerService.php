...
class getCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 9 => ($container->privates['ux.twig_component.cache_warmer'] ?? $container->load('getUx_TwigComponent_CacheWarmerService'));
            yield 10 => ($container->privates['EasyCorp\\Bundle\\EasyAdminBundle\\Cache\\CacheWarmer'] ?? $container->load('getCacheWarmer2Service'));
            yield 11 => ($container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ?? $container->load('getWebpackEncore_EntrypointLookup_CacheWarmerService'));
        }, 12), true, ($container->targetDir.''.'/App_KernelDevDebugContainerDeprecations.log'));
    }
}
