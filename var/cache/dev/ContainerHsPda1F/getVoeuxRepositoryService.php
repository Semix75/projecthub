 ...
 */
class getVoeuxRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VoeuxRepository' shared autowired service.
     *
     * @return \App\Repository\VoeuxRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VoeuxRepository.php';

        return $container->privates['App\\Repository\\VoeuxRepository'] = new \App\Repository\VoeuxRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
