...
class getApiPlatform_StateProvider_CreateService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'state'.\DIRECTORY_SEPARATOR.'CreateProvider.php';
