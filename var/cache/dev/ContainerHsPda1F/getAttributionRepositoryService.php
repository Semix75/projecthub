 ...
 */
class getAttributionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AttributionRepository' shared autowired service.
     *
     * @return \App\Repository\AttributionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AttributionRepository.php';

        return $container->privates['App\\Repository\\AttributionRepository'] = new \App\Repository\AttributionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
