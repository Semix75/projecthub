...
class __TwigTemplate_654cfefa2a635ca486a8a8481fde961f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["encore_asset"]) {
            ...
            // line 4
            yield "        ";
            yield $this->extensions['Symfony\WebpackEncoreBundle\Twig\EntryFilesTwigExtension']->renderWebpackLinkTags(CoreExtension::getAttribute($this->env, $this->source, $context["encore_asset"], "value", [], "any", false, false, false, 4), CoreExtension::getAttribute($this->env, $this->source, $context["encore_asset"], "webpackPackageName", [], "any", false, false, false, 4), CoreExtension::getAttribute($this->env, $this->source, $context["encore_asset"], "webpackEntrypointName", [], "any", false, false, false, 4), CoreExtension::getAttribute($this->env, $this->source, $context["encore_asset"], "htmlAttributes", [], "any", false, false, false, 4));
            yield "
    ";
        }
...
{% for encore_asset in assets %}
    ...
    {% endguard %}
{% endfor %}
", "@EasyAdmin/includes/_encore_link_tags.html.twig", "C:\\Users\\Lyesri\\Desktop\\PROJET MDI\\projecthub\\vendor\\easycorp\\easyadmin-bundle\\templates\\includes\\_encore_link_tags.html.twig");
    }
}
