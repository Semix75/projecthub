...
/* user/show.html.twig */
class __TwigTemplate_a4415a499bda5ee26979138aa1b9260b extends Template
{
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 32
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 32, $this->source); })()), "lastname", [], "any", false, false, false, 32), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "user/show.html.twig", "/home/adel/dev/ProjectHub/templates/user/show.html.twig");
    }
}
