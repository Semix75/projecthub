...
class __TwigTemplate_d91c47485f7307e983910d6f16c7e455 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        if ( !(((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["ea"] ?? null), "crud", [], "any", false, true, false, 1), "areNullValuesHidden", [], "any", true, true, false, 1) &&  !(null === CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["ea"]) || array_key_exists("ea", $context) ? $context["ea"] : (function () { throw new RuntimeError('Variable "ea" does not exist.', 1, $this->source); })()), "crud", [], "any", false, false, false, 1), "areNullValuesHidden", [], "any", false, false, false, 1)))) ? (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["ea"]) || array_key_exists("ea", $context) ? $context["ea"] : (function () { throw new RuntimeError('Variable "ea" does not exist.', 1, $this->source); })()), "crud", [], "any", false, false, false, 1), "areNullValuesHidden", [], "any", false, false, false, 1)) : (false))) {
            // line 2
...
{% endif %}
", "@EasyAdmin/label/null.html.twig", "C:\\Users\\Lyesri\\Desktop\\PROJET MDI\\projecthub\\vendor\\easycorp\\easyadmin-bundle\\templates\\label\\null.html.twig");
    }
}
