...
class __TwigTemplate_60a37494c6635beff45b1d331ec1c786 extends Template
{
...
";
    ...
    ";
        // line 156
        if ( !((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "componentCount", [], "any", true, true, false, 156)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 156, $this->source); })()), "componentCount", [], "any", false, false, false, 156))) : (""))) {
            // line 157
...
{% endblock %}
", "@TwigComponent/Collector/twig_component.html.twig", "C:\\Users\\Lyesri\\Desktop\\PROJET MDI\\projecthub\\vendor\\symfony\\ux-twig-component\\templates\\Collector\\twig_component.html.twig");
    }
}
