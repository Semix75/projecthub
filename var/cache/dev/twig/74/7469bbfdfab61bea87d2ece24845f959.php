...
/* voeux/edit.html.twig */
class __TwigTemplate_7279ec5c9c55f5cd803e6fe05ae1c322 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "voeux/edit.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "voeux/edit.html.twig"));

        $this->parent = $this->loadTemplate("base.html.twig", "voeux/edit.html.twig", 1);
    ...
    <div class=\"row justify-content-center\">
        ...
        yield "
                    <div class=\"d-grid\">
                        <button type=\"submit\" class=\"btn btn-primary\">Mettre à jour mes vœux</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    document.addEventListener(\"DOMContentLoaded\", function () {
        ...
        selects.forEach(select => {
            select.addEventListener(\"change\", function () {
                ...
                // Récupérer tous les projets sélectionnés
                selects.forEach(s => {
                    if (s.value) {
                ...
                // Désactiver les options déjà sélectionnées dans d'autres sélecteurs
                selects.forEach(s => {
...
";
    ...
    {
        return array (  157 => 36,  146 => 27,  137 => 24,  133 => 23,  129 => 22,  126 => 21,  122 => 20,  111 => 12,  105 => 9,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block title %}Modifier mes Vœux{% endblock %}

{% block body %}
<div class=\"container mt-4\">
    <h1 class=\"text-center\">Modifier mes vœux</h1>
    <p class=\"text-center\">
        <a href=\"{{ path('app_profil') }}\">Retour à mon profil</a>
    </p>
...
{% endblock %}
", "voeux/edit.html.twig", "/home/adel/dev/ProjectHub/templates/voeux/edit.html.twig");
    }
}
