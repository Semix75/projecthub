...
// lancer la fixture avec la commande suivante : php bin/console doctrine:fixtures:load --group=friends --append
class friendsFixtures extends Fixture implements FixtureGroupInterface{
