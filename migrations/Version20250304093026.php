 ...
 */
final class Version20250304093026 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__voeux AS SELECT id, user_id, projet_id, priorite FROM voeux');
        $this->addSql('DROP TABLE voeux');
        $this->addSql('CREATE TABLE voeux (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, projet_id INTEGER NOT NULL, priorite INTEGER DEFAULT NULL, CONSTRAINT FK_917F7851A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_917F7851C18272 FOREIGN KEY (projet_id) REFERENCES projet (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO voeux (id, user_id, projet_id, priorite) SELECT id, user_id, projet_id, priorite FROM __temp__voeux');
