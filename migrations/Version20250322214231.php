 ...
 */
final class Version20250322214231 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE message (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, send_by_id INTEGER DEFAULT NULL, conversation_id INTEGER DEFAULT NULL, content VARCHAR(255) DEFAULT NULL, send_at DATETIME DEFAULT NULL, is_read BOOLEAN DEFAULT NULL, read_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
